    ...
    supportFragmentManager
        ...
        .apply {
            if (byFade) {
                ...
                if (slideBack) {
                    setCustomAnimations(
                        com.test.mornhouse.R.anim.enter_from_left,
                        com.test.mornhouse.R.anim.exit_to_right,
                        com.test.mornhouse.R.anim.enter_from_right,
                        com.test.mornhouse.R.anim.exit_to_left
                    )
                } else {
                    setCustomAnimations(
                        com.test.mornhouse.R.anim.enter_from_right,
